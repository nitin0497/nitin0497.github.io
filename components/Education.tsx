...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-16 py-10 fade-in">
      <div className="flex-shrink-0 w-48 h-48 md:w-64 md:h-64 relative mt-8 md:mt-12">
        ...
        <div className="flex flex-wrap justify-center md:justify-start gap-4">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-blue-700 rounded-lg hover:bg-slate-50 transition-colors shadow-sm"
            >
              <Linkedin size={18} />
              <span>LinkedIn</span>
            </a>
